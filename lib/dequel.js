...
class Model {
  ...
  static delete(condition, ...values) {
    let clause;
  ...
  save() {
    return this.constructor.insert(this, { onConflict: 'update' });
  }

  destroy() {
    const primaryKey = this.constructor.primaryKey;
    return this.constructor.delete(`${primaryKey} = $1`, this[primaryKey]);
  }
